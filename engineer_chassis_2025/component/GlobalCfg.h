...
#define ARM_SUCKER_BLOCK_CURRENT_MAX   2080.0f

#define LEFT_SUCKER_BLOCK_CURRENT_MIN   2000.0f
#define LEFT_SUCKER_BLOCK_CURRENT_MAX   2100.0f

#define RIGHT_SUCKER_BLOCK_CURRENT_MIN   2000.0f
