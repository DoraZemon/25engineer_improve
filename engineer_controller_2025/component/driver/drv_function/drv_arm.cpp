...
void arm_device::init() {
    ...
    motor.motor4.init(&Arm_Motor4_Can, true, Arm_Motor4_Id, DJI_M2006, ArmMotor4UpdateBinarySemHandle);
    motor.motor5.init(&Arm_Motor5_Can, true, Arm_Motor5_Id, DJI_M2006, ArmMotor5UpdateBinarySemHandle);
...
void arm_device::update_data() {
    ...
    data.motor_pos_get.motor4 = motor.motor4.get_total_rounds() / 36.f;//减速比
    data.motor_pos_get.motor5 = motor.motor5.get_total_rounds() / 36.f;
...
void arm_device::update_control(bool is_enable) {
    ...
    if (is_ctrl_enable) {
        ...
        motor.motor3.set_current(motor.motor3.lqr.calculate(data.motor_pos_get.motor3,
                                                            ...
                                                            0.001));
        motor.motor4.set_current(motor.motor4.lqr.calculate(data.motor_pos_get.motor4,
                                                            motor.motor4.get_speed()/ 36.f,
                                                            data.motor_pos_set.motor4,
                                                            0.001));
        motor.motor5.set_current(motor.motor5.lqr.calculate(data.motor_pos_get.motor5,
                                                            motor.motor5.get_speed()/ 36.f,
