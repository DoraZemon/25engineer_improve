...
constexpr uint32_t Arm_Motor3_Id = 4;

constexpr uint32_t Arm_Motor4_Id = 2;

constexpr uint32_t Arm_Motor5_Id = 1;

constexpr uint32_t Arm_Motor6_Id = 3;
...
class arm_device {
  ...
  struct {
    ...
    dji_motor_device motor4; //关节4电机
    dji_motor_device motor5; //关节5电机
